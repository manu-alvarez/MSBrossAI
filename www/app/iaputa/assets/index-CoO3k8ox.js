...
• 🧠 Multi-LLM en fallback (Groq → Ollama → OpenRouter)`,default:`Entendido. En modo demo puro no conecto con el backend esclavo en local, por favor levanta la API de FastAPI.`};function nl(){let[e,t]=(0,_.useState)([]),[n,r]=(0,_.useState)(``),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)(null),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(!1),[m,h]=(0,_.useState)(`idle`),[g,v]=(0,_.useState)(0),y=(0,_.useRef)(null),b=(0,_.useRef)(null),x=(0,_.useRef)([]);(0,_.useEffect)(()=>{let e=el?`${Qc}status`:`${Qc}/status`;fetch(e,{signal:AbortSignal.timeout(3e3)}).then(e=>{e.ok||s(!0)}).catch(()=>s(!0))},[]),(0,_.useEffect)(()=>{y.current?.scrollIntoView({behavior:`smooth`})},[e]);let S=(0,_.useCallback)(e=>{if(`speechSynthesis`in window){window.speechSynthesis.cancel();let t=new SpeechSynthesisUtterance(e);t.lang=`es-ES`,t.rate=1,t.pitch=1,t.onstart=()=>{p(!0),h(`speaking`)},t.onend=()=>{p(!1),h(`idle`)},t.onerror=()=>{p(!1),h(`idle`)},window.speechSynthesis.speak(t)}},[]),C=(0,_.useCallback)(async()=>{try{let e=await navigator.mediaDevices.getUserMedia({audio:!0}),n=new MediaRecorder(e);b.current=n,x.current=[],n.ondataavailable=e=>{e.data.size>0&&x.current.push(e.data)},n.onstop=async()=>{e.getTracks().forEach(e=>e.stop()),d(!1),h(`thinking`);let n=new Blob(x.current,{type:`audio/webm`});if(o){t(e=>[...e,{id:crypto.randomUUID(),role:`user`,content:`🎤 [Voz capturada]`,timestamp:new Date}]),setTimeout(()=>{t(e=>[...e,{id:crypto.randomUUID(),role:`assistant`,content:`Grabación procesada localmente en demo.`,timestamp:new Date}]),S(`Procesado localmente.`),h(`idle`)},1e3);return}let r=new FormData;r.append(`audio_file`,n,`audio.webm`),t(e=>[...e,{id:crypto.randomUUID(),role:`user`,content:`🎤 [Procesando comandos de voz...]`,timestamp:new Date}]);try{let e=await(await fetch(el?`${Qc}voice-command`:`${Qc}/voice-command`,{method:`POST`,headers:{"x-api-key":$c},body:r})).json(),n={id:crypto.randomUUID(),role:`assistant`,content:e.response||e.transcript||`Sin respuesta`,timestamp:new Date,audioUrl:e.audio_url};t(e=>[...e,n]),e.audio_url?new Audio(e.audio_url).play().catch(()=>S(e.response||e.transcript||``)):S(e.response||e.transcript||``)}catch(e){t(t=>[...t,{id:crypto.randomUUID(),role:`system`,content:`❌ Error de backend esclavo: ${String(e)}`,timestamp:new Date}]),h(`error`),setTimeout(()=>h(`idle`),3e3)}},n.start(),d(!0),h(`listening`),setTimeout(()=>{b.current&&b.current.state===`recording`&&b.current.stop()},15e3)}catch{h(`error`),setTimeout(()=>h(`idle`),3e3)}},[o,S]),w=(0,_.useCallback)(()=>{b.current&&b.current.state===`recording`&&b.current.stop()},[]),T=(0,_.useCallback)(async e=>{if(e.trim())if(a(!0),h(`thinking`),t(t=>[...t,{id:crypto.randomUUID(),role:`user`,content:e,timestamp:new Date}]),o){let n=e.toLowerCase(),r=tl.default;for(let[e,t]of Object.entries(tl))if(n.includes(e)){r=t;break}setTimeout(()=>{t(e=>[...e,{id:crypto.randomUUID(),role:`assistant`,content:r,timestamp:new Date}]),S(r),a(!1)},1e3)}else{try{let n=await(await fetch(el?`${Qc}text-command`:`${Qc}/text-command`,{method:`POST`,headers:{"Content-Type":`application/json`,"x-api-key":$c},body:JSON.stringify({text:e})})).json(),r={id:crypto.randomUUID(),role:`assistant`,content:n.response||n.error||`Sin respuesta`,timestamp:new Date,audioUrl:n.audio_url};t(e=>[...e,r]),n.audio_url?new Audio(n.audio_url).play().catch(()=>S(n.response||``)):S(n.response||``)}catch(e){t(t=>[...t,{id:crypto.randomUUID(),role:`system`,content:`❌ Host: Imposible conectar al backend local: ${String(e)}`,timestamp:new Date}]),h(`error`),setTimeout(()=>h(`idle`),3e3)}a(!1)}},[o,S]);return(0,X.jsxs)(`div`,{className:`app-container`,children:[(0,X.jsx)(`div`,{className:`luxury-orb-background`,children:(0,X.jsx)(Xc,{state:m,volume:g})}),(0,X.jsx)(`div`,{className:`luxury-dashboard`,children:(0,X.jsxs)(`div`,{className:`glass-panel chat-glass-panel`,children:[(0,X.jsx)(`header`,{className:`glass-header`,children:(0,X.jsxs)(`div`,{className:`brand`,children:[(0,X.jsx)(`span`,{className:`brand-logo`,children:`🤖`}),(0,X.jsxs)(`div`,{className:`brand-text`,children:[(0,X.jsx)(`h1`,{children:`IAPuta OS`}),(0,X.jsx)(`span`,{className:`status-badge ${o?`demo`:`online`}`,children:o?`Host Only`:`Host + Local`})]})]})}),(0,X.jsxs)(`div`,{className:`chat-area`,children:[e.length===0?(0,X.jsxs)(`div`,{className:`chat-empty-state`,children:[(0,X.jsx)(`h2`,{children:`Awaiting Directives`}),(0,X.jsx)(`p`,{children:`El núcleo neuronal está conectado. Estoy lista para gestionar tu entorno.`})]}):e.map(e=>(0,X.jsx)(`div`,{className:`chat-message chat-message--${e.role}`,children:(0,X.jsxs)(`div`,{className:`chat-bubble`,children:[(0,X.jsx)(`p`,{children:e.content}),(0,X.jsx)(`span`,{className:`chat-time`,children:e.timestamp.toLocaleTimeString(`es-ES`,{hour:`2-digit`,minute:`2-digit`})})]})},e.id)),i&&(0,X.jsx)(`div`,{className:`chat-message chat-message--loading`,children:(0,X.jsx)(`div`,{className:`chat-bubble`,children:(0,X.jsxs)(`div`,{className:`loader-dots`,children:[(0,X.jsx)(`span`,{}),(0,X.jsx)(`span`,{}),(0,X.jsx)(`span`,{})]})})}),(0,X.jsx)(`div`,{ref:y})]}),(0,X.jsxs)(`form`,{className:`glass-input-dock`,onSubmit:e=>{e.preventDefault(),n.trim()&&!i&&(T(n),r(``))},children:[(0,X.jsx)(`input`,{type:`text`,placeholder:`Inyectar comandos al núcleo...`,value:n,onChange:e=>r(e.target.value),disabled:i,className:`glass-input`}),(0,X.jsx)(`button`,{type:`button`,className:`btn-icon ${u?`pulsing`:``}`,onClick:u?w:C,children:u?`⏹️`:`🎤`}),(0,X.jsx)(`button`,{type:`button`,className:`btn-icon`,onClick:()=>l(`📸`),children:`👁️`})]})]})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(_.StrictMode,{children:(0,X.jsx)(nl,{})}));