...
void main() {
	...
	`}var lo=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new vi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!0,depthWrite:!1,blending:2}),x=new gi(h,b);e.add(x),o.current=x;let S=new On;for(let e=0;e<3;e++){let t=new $r(new Ei(1.5+e*.4,.01,16,100),new Vr({color:Yc.idle.glow,transparent:!0,opacity:.3/(e+1)}));t.rotation.x=Math.PI/2+e*.3,t.rotation.y=e*.5,S.add(t)}e.add(S),s.current=S;let C=new ma(4210752,.5);e.add(C);let w=new fa(Yc.idle.core,1,10);w.position.set(0,0,3),e.add(w);let T=0,E=()=>{requestAnimationFrame(E),T+=.016;let n=c.current,r=l.current;if(r.core.lerp(n.core,.02),r.glow.lerp(n.glow,.02),r.particles.lerp(n.particles,.02),p.uniforms&&(p.uniforms.uTime.value=T,p.uniforms.uColor.value.copy(r.core),p.uniforms.uVolume.value=t),b.uniforms&&(b.uniforms.uTime.value=T,b.uniforms.uColor.value.copy(r.particles),b.uniforms.uVolume.value=t),s.current&&s.current.children.forEach((e,n)=>{e.rotation.z=T*(.1+n*.05),e.rotation.x=Math.PI/2+Math.sin(T*.5+n)*.3,e.material.opacity=.3/(n+1)*(.5+t*.5),e.material.color.copy(r.glow)}),a.current){let e=1+t*.3;a.current.scale.setScalar(e)}u.render(e,d)};E();let D=()=>{if(!n.current)return;let e=n.current.offsetWidth,t=n.current.offsetHeight;d.aspect=e/t,d.updateProjectionMatrix(),u.setSize(e,t)};return window.addEventListener(`resize`,D),()=>{window.removeEventListener(`resize`,D),n.current&&u.domElement&&n.current.removeChild(u.domElement),u.dispose()}},[]);return(0,_.useEffect)(()=>{c.current=Yc[e]},[e]),(0,_.useEffect)(()=>u(),[u]),(0,X.jsx)(`div`,{ref:n,style:{width:`100%`,height:`100%`,position:`relative`}})},Zc=window.location.hostname===`msbross.me`,Qc=Zc?`./api.php?action=`:`https://lover-wifi-antiques-volumes.trycloudflare.com/api`,$c=`YOUR_IAPUTA_API_KEY_HERE`,el=Zc,tl={hola:`¡Hola! Soy IAPuta OS, tu asistente IA personal de élite. ¿En qué puedo ayudarte hoy?`,hello:`Hello! I am IAPuta OS, your luxury AI assistant. How can I act for you?`,ayuda:`Tengo acceso a:
• 📷 Análisis de visión y pantalla
• 🌐 Búsquedas avanzadas
• 💻 Shell y manipulación local
• 🧠 Multi-LLM en fallback (Groq → Ollama → OpenRouter)`,default:`Entendido. En modo demo puro no conecto con el backend esclavo en local, por favor levanta la API de FastAPI.`};function nl(){let[e,t]=(0,_.useState)([]),[n,r]=(0,_.useState)(``),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)(null),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(!1),[m,h]=(0,_.useState)(`idle`),[g,v]=(0,_.useState)(0),y=(0,_.useRef)(null),b=(0,_.useRef)(null);(0,_.useRef)([]),(0,_.useEffect)(()=>{let e=el?`${Qc}status`:`${Qc}/status`;fetch(e,{signal:AbortSignal.timeout(3e3)}).then(e=>{e.ok||s(!0)}).catch(()=>s(!0))},[]),(0,_.useEffect)(()=>{y.current?.scrollIntoView({behavior:`smooth`})},[e]);let x=(0,_.useCallback)(e=>{if(`speechSynthesis`in window){window.speechSynthesis.cancel();let t=new SpeechSynthesisUtterance(e),n=()=>{let e=window.speechSynthesis.getVoices(),n=e.find(e=>e.name===`Google español`)||e.find(e=>e.lang.startsWith(`es`)&&e.name.includes(`Premium`))||e.find(e=>e.lang.startsWith(`es`)&&(e.name.includes(`Monica`)||e.name.includes(`Jorge`)||e.name.includes(`Diego`)))||e.find(e=>e.lang.startsWith(`es-ES`))||e.find(e=>e.lang.startsWith(`es`));n&&(t.voice=n),t.lang=`es-ES`,t.rate=1,t.pitch=1.05,t.onstart=()=>{p(!0),h(`speaking`)},t.onend=()=>{p(!1),h(`idle`)},t.onerror=()=>{p(!1),h(`idle`)},window.speechSynthesis.speak(t)};if(window.speechSynthesis.getVoices().length===0){let e=!1,t=()=>{e||(e=!0,n())};window.speechSynthesis.onvoiceschanged=t,setTimeout(t,250)}else n()}},[]),S=(0,_.useCallback)(()=>{let e=window.SpeechRecognition||window.webkitSpeechRecognition;if(!e){t(e=>[...e,{id:crypto.randomUUID(),role:`system`,content:`❌ Web Speech API no soportada en este navegador.`,timestamp:new Date}]);return}try{let n=new e;n.lang=`es-ES`,n.interimResults=!1,n.maxAlternatives=1,n.onstart=()=>{d(!0),h(`listening`)},n.onresult=async e=>{let n=e.results[0][0].transcript;d(!1),h(`thinking`),t(e=>[...e,{id:crypto.randomUUID(),role:`user`,content:`🎤 ${n}`,timestamp:new Date}]);try{let e=await(await fetch(el?`${Qc}text-command`:`${Qc}/text-command`,{method:`POST`,headers:{"Content-Type":`application/json`,"x-api-key":$c},body:JSON.stringify({text:n})})).json(),r=e.response||e.transcript||`Sin respuesta`;t(e=>[...e,{id:crypto.randomUUID(),role:`assistant`,content:r,timestamp:new Date}]);let i=r.toLowerCase();(i.includes(`creando tarea`)||i.includes(`tarea creada`)||i.includes(`anotado en taskflow`))&&fetch(`${Qc}vault-update`,{method:`POST`,body:JSON.stringify({notification:{type:`TASK`,content:`Nueva tarea desde IAPuta: ${n.slice(0,30)}...`},app:`taskflow`,data:{last_sync:Date.now()}})}).catch(()=>{}),(i.includes(`temporizador`)||i.includes(`minutos en dohler`))&&fetch(`${Qc}vault-update`,{method:`POST`,body:JSON.stringify({notification:{type:`TIMER`,content:`Timer iniciado desde IAPuta`},app:`dohler`,data:{timer_active:!0}})}).catch(()=>{}),x(r)}catch(e){t(t=>[...t,{id:crypto.randomUUID(),role:`system`,content:`❌ Error de conexión: ${String(e)}`,timestamp:new Date}]),h(`error`),setTimeout(()=>h(`idle`),3e3)}},n.onerror=()=>{d(!1),h(`error`),setTimeout(()=>h(`idle`),3e3)},n.onend=()=>{d(!1),h(e=>e===`listening`?`idle`:e)},n.start(),b.current=n}catch{h(`error`),setTimeout(()=>h(`idle`),3e3)}},[x]),C=(0,_.useCallback)(()=>{b.current&&b.current.stop&&(b.current.stop(),d(!1))},[]),w=(0,_.useCallback)(async e=>{if(e.trim())if(a(!0),h(`thinking`),t(t=>[...t,{id:crypto.randomUUID(),role:`user`,content:e,timestamp:new Date}]),o){let n=e.toLowerCase(),r=tl.default;for(let[e,t]of Object.entries(tl))if(n.includes(e)){r=t;break}setTimeout(()=>{t(e=>[...e,{id:crypto.randomUUID(),role:`assistant`,content:r,timestamp:new Date}]),x(r),a(!1)},1e3)}else{try{let n=await(await fetch(el?`${Qc}text-command`:`${Qc}/text-command`,{method:`POST`,headers:{"Content-Type":`application/json`,"x-api-key":$c},body:JSON.stringify({text:e})})).json(),r=n.response||n.error||`Sin respuesta`;t(e=>[...e,{id:crypto.randomUUID(),role:`assistant`,content:r,timestamp:new Date}]);let i=r.toLowerCase();(i.includes(`creando tarea`)||i.includes(`tarea creada`)||i.includes(`anotado en taskflow`))&&fetch(`${Qc}vault-update`,{method:`POST`,body:JSON.stringify({notification:{type:`TASK`,content:`Nueva tarea desde IAPuta: ${e.slice(0,30)}...`},app:`taskflow`,data:{last_sync:Date.now()}})}).catch(()=>{}),(i.includes(`temporizador`)||i.includes(`minutos en dohler`))&&fetch(`${Qc}vault-update`,{method:`POST`,body:JSON.stringify({notification:{type:`TIMER`,content:`Timer iniciado desde IAPuta`},app:`dohler`,data:{timer_active:!0}})}).catch(()=>{}),x(r)}catch(e){t(t=>[...t,{id:crypto.randomUUID(),role:`system`,content:`❌ Host: Imposible conectar al backend local: ${String(e)}`,timestamp:new Date}]),h(`error`),setTimeout(()=>h(`idle`),3e3)}a(!1)}},[o,x]);return(0,X.jsxs)(`div`,{className:`app-container`,children:[(0,X.jsx)(`div`,{className:`luxury-orb-background`,children:(0,X.jsx)(Xc,{state:m,volume:g})}),(0,X.jsx)(`div`,{className:`luxury-dashboard`,children:(0,X.jsxs)(`div`,{className:`glass-panel chat-glass-panel`,children:[(0,X.jsx)(`header`,{className:`glass-header`,children:(0,X.jsxs)(`div`,{className:`brand`,children:[(0,X.jsx)(`span`,{className:`brand-logo`,children:`🤖`}),(0,X.jsxs)(`div`,{className:`brand-text`,children:[(0,X.jsx)(`h1`,{children:`IAPuta OS`}),(0,X.jsx)(`span`,{className:`status-badge ${o?`demo`:`online`}`,children:o?`Host Only`:`Host + Local`})]})]})}),(0,X.jsxs)(`div`,{className:`chat-area`,children:[e.length===0?(0,X.jsxs)(`div`,{className:`chat-empty-state`,children:[(0,X.jsx)(`h2`,{children:`Awaiting Directives`}),(0,X.jsx)(`p`,{children:`El núcleo neuronal está conectado. Estoy lista para gestionar tu entorno.`})]}):e.map(e=>(0,X.jsx)(`div`,{className:`chat-message chat-message--${e.role}`,children:(0,X.jsxs)(`div`,{className:`chat-bubble`,children:[(0,X.jsx)(`p`,{children:e.content}),(0,X.jsx)(`span`,{className:`chat-time`,children:e.timestamp.toLocaleTimeString(`es-ES`,{hour:`2-digit`,minute:`2-digit`})})]})},e.id)),i&&(0,X.jsx)(`div`,{className:`chat-message chat-message--loading`,children:(0,X.jsx)(`div`,{className:`chat-bubble`,children:(0,X.jsxs)(`div`,{className:`loader-dots`,children:[(0,X.jsx)(`span`,{}),(0,X.jsx)(`span`,{}),(0,X.jsx)(`span`,{})]})})}),(0,X.jsx)(`div`,{ref:y})]}),(0,X.jsxs)(`form`,{className:`glass-input-dock`,onSubmit:e=>{e.preventDefault(),n.trim()&&!i&&(w(n),r(``))},children:[(0,X.jsx)(`input`,{type:`text`,placeholder:`Inyectar comandos al núcleo...`,value:n,onChange:e=>r(e.target.value),disabled:i,className:`glass-input`}),(0,X.jsx)(`button`,{type:`button`,className:`btn-icon ${u?`pulsing`:``}`,onClick:u?C:S,children:u?`⏹️`:`🎤`}),(0,X.jsx)(`button`,{type:`button`,className:`btn-icon`,onClick:()=>l(`📸`),children:`👁️`})]})]})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(_.StrictMode,{children:(0,X.jsx)(nl,{})}));