...
export default function TutorView() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-200px)]">
      <div className="glass-panel p-4 rounded-t-2xl flex items-center justify-between border-b-0 rounded-b-none z-10">
      ...
      <div className="glass-panel p-4 rounded-b-2xl border-t-0 z-10">
