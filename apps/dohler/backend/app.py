...
JWT_SECRET = os.environ.get("DOHLER_JWT_SECRET", "dohler-secret-change-in-prod")
...
app = FastAPI(title="DÖHLER Process Control", lifespan=lifespan)
...
@app.get("/health")
async def health():
    return {"status": "ok", "app": "DOHLER Process Control"}
