"""
MSBrossAI — Upload ONLY the main portal and Atenea landing page to FTP.
Usage: FTP_PASSWORD=xxx python3 deploy/ftp-upload-portal-and-atenea.py
"""
import ftplib
import os
import sys
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n📦 Sincronizando Portal de Entrada y Landing de Atenea...")
        ...
        ftp.quit()
        print("\n🚀 Sincronización FTP del Portal completada con éxito!")
